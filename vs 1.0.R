...
# 1. PREPARACIÓN:
#    - Asegúrate de tener el archivo "superficie_puno.csv" en tu directorio de trabajo
#    - O modifica la ruta en la función preparar_datos()
#    - Instala todas las librerías necesarias (se instalan automáticamente)

# 2. EJECUCIÓN:
#    - Ejecuta todo el código
#    - La aplicación se abrirá en tu navegador web
#    - Si no se abre automáticamente, copia la URL que aparece en la consola

# 3. FUNCIONALIDADES:
#    - Dashboard: Vista general con métricas principales
#    - Mapa Interactivo: Exploración geoespacial de los distritos
#    - Análisis Distritos: Comparaciones detalladas entre distritos
#    - Análisis Provincias: Agregaciones por provincia
#    - Datos Detallados: Tablas completas y opciones de descarga
#    - Información: Guía de uso de la aplicación

# 4. FILTROS DISPONIBLES:
#    - Filtro por provincia
#    - Superficie mínima (slider)
#    - Búsqueda por nombre de distrito
#    - Los filtros se aplican en tiempo real

# 5. INTERACTIVIDAD:
#    - Gráficos con hover y zoom
#    - Mapa clickeable para información detallada
#    - Tablas ordenables y filtrables
#    - Descarga de datos procesados

# 6. PERSONALIZACIÓN:
#    - Modifica colores en la sección CSS del UI
#    - Ajusta coordenadas de distritos según tus datos reales
#    - Agrega más visualizaciones según tus necesidades